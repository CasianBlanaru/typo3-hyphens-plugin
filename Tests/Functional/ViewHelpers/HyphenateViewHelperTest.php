...
namespace LIA\LiaHyphens\Tests\Unit\ViewHelpers;
...
final class HyphenateViewHelperTest extends FunctionalTestCase
{
    ...
    public function callWitoNoOrWrongArgumentsTest($template): void
    {
        ...
        $template = '<html xmlns:lih="http://typo3.org/ns/LiaHyphens/ViewHelpers" data-namespace-typo3-fluid="true">' . $template . '</html>';
    ...
    {
        $template = '<html xmlns:lih="http://typo3.org/ns/LiaHyphens/ViewHelpers" data-namespace-typo3-fluid="true"><f:format.raw>' . $template . '</f:format.raw></html>';
        $context = $this->get(RenderingContextFactory::class)->create();
